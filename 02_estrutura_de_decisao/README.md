...
#### Para esses exercícios utilizei o doctest em arquivo .txt, para executar basta usar o exemplo do comando abaixo 
```
    #executado no Windows
    py -m doctest -v  .\01_exercicio_test.txt
```
...
Se o usuário informar o valor de A igual a zero, a equação não é do segundo grau e o programa não deve fazer pedir os demais valores, sendo encerrado;
    a. Se o delta calculado for negativo, a equação não possui raizes reais. Informe ao usuário e encerre o b/programa;
